...
<div class="px-4 py-6 sm:px-0">
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-gray-900">Create New Reservation</h1>
        <p class="mt-1 text-sm text-gray-600">Fill in the reservation details below. The system will automatically calculate the total amount.</p>
    </div>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="date" 
                           ...
                           min="{{ old('check_in_date', today()->format('Y-m-d')) }}"
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea id="special_requests" 
                              ...
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('special_requests') border-red-500 @enderror">{{ old('special_requests') }}</textarea>
            ...
            <div class="mt-6 p-4 bg-gray-50 rounded-md">
                ...
                <div class="grid grid-cols-3 gap-4 text-sm">
                    <div>
                        ...
                        <span id="num_nights" class="font-medium text-gray-900 ml-2">0</span>
                    </div>
                    <div>
                        <span class="text-gray-500">Price per Night:</span>
                        <span id="price_per_night" class="font-medium text-gray-900 ml-2">RWF 0</span>
                    </div>
                    <div>
                        <span class="text-gray-500">Total Amount:</span>
                        <span id="total_amount" class="font-bold text-gray-900 ml-2">RWF 0</span>
                    </div>
                </div>
            </div>
