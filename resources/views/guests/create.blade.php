...
<div class="px-4 py-6 sm:px-0">
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-gray-900">Register New Guest</h1>
        <p class="mt-1 text-sm text-gray-600">Fill in the guest details below to register a new guest.</p>
    </div>

    <div class="bg-white shadow sm:rounded-lg">
        <form action="{{ route('guests.store') }}" method="POST" class="p-6">
            @csrf
